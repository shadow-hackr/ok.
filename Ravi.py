...
__author__ = 'Shadow_Hacker'
__copyright = 'All rights reserved . Copyright  Kashmiri-Hacker'
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        os.system('xdg-open https://https://www.facebook.com/programmer320')
        os.system('clear')
done = False
os.system('rm -rf .txt')
...
def action():
    ...
    os.system('clear')
    print logo
    jalan ('\x1b[1;92mUSE AIROPLANE MODE AFTER EVERY 10 MINUTES')
    print(47*'-')
    xxx = str(len(id))
